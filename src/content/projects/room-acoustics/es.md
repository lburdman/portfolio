...
summary: 'Un motor en Go que responde dos preguntas sobre una sala rectangular — cuánto tarda el sonido en decaer y qué modos propios impone la geometría — y demuestra sus respuestas contra un registro generado de 78 verificaciones con tolerancia declarada, una de las cuales queda fallando porque el error está en la especificación, no en el código.'
---
...
El reporte generado registra **78 verificaciones: 77 pasan, una falla.**
...
## La verificación que falla

Una verificación falla, y permanece en el reporte.

La especificación pide un RT60 en medias frecuencias de 0,40 s ±8% a partir de un tratamiento acústico declarado. Ese tratamiento da **0,448 s — 12,007% por encima.** La aritmética dice que alcanzar 0,40 s requeriría 5,20 m² de lana mineral donde la especificación indica 4,33 m².

El defecto está entonces en el valor esperado de la especificación, no en el motor. No se amplió la tolerancia ni se borró la verificación; un registro de decisión de arquitectura documenta el cálculo. Un reporte de validación que solo muestra verde no es evidencia de corrección — es evidencia de que no se dejó que nada discrepara.
...
- Una falla documentada y sin resolver, cuya causa se rastrea hasta la especificación
...
La verificación que falla enseñó la lección más útil. El reflejo ante un resultado en rojo es ajustar la tolerancia hasta que pase, y ese reflejo destruye lo único para lo que sirve una suite de validación. Perseguir la discrepancia a través de la aritmética, en cambio, convirtió una molestia en la línea más informativa del reporte: la especificación pide algo que su propio tratamiento no puede entregar, y ahora eso está escrito donde el próximo lector lo va a encontrar.
